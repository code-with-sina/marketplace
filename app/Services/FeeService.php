...
class FeeService
{
    ...
    public function getAdmin()
    {
        ...
        // $this->admin = Administrator::latest()->first()->adminaccount()->first();
        Log::error([$this->admin]);
    ...
    public function fetchAmount($amount)
    {
        if ($this->failstate)
            return $this;
    ...
    public function createJournal()
    {
        ...
        try {
            TransactionalJournal::create([
                ...
                'source_name' => $this->user->customerstatus()->first()->customer()->first()->escrowaccount()->first()->escrowId,
    ...
    */
    ...
    public function createNaration()
    {
        ...
        $isHtml = true;
        return __(
            "An administrative fee has been charged on the total sum of :amount " . ($isHtml ? "<br>" : "\n") .
