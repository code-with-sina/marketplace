...
class TradeRequestJob implements ShouldQueue
{
    ...
    {
        TradeRequestEvent::dispatch($this->owner, $this->recipient, $this->amount, $this->amountInNaira, $this->item, $this->wallet_name, $this->item_id);
    }
}
