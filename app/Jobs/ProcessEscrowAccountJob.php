...
class ProcessEscrowAccountJob implements ShouldQueue, ShouldBeUnique
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels, HasObjectConverter, HasEscrowAccount;
    protected $uuid;
    public $tries = 3;
    /**
